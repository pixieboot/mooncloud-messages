...
const bcryipt = __importStar(require("bcrypt"));
var Bcrypt;
(function (Bcrypt) {
    ...
    Bcrypt.hashedPassword = hashedPassword;
    function comparePasswords(pwd, pwdDB) {
        return bcryipt.compareSync(pwd, pwdDB);
    }
    Bcrypt.comparePasswords = comparePasswords;
})(Bcrypt || (exports.Bcrypt = Bcrypt = {}));
